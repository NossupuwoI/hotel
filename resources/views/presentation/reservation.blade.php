                  ...
                  @endforeach
                            ...
                            <form action="/reservation/traitement" method="POST">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="time" class="form-control" id="name" name="heure_arriver" placeholder="heure">
                                            <label for="name">Heure D'arriver</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="time" class="form-control" id="name" name="heure_depart" placeholder="heure">
